...
require 'orientdb-client-2.0.3.jar'
require 'orientdb-core-2.0.3.jar'
require 'orientdb-distributed-2.0.3.jar'
require 'orientdb-enterprise-2.0.3.jar'
require 'orientdb-etl-2.0.3.jar'
require 'orientdb-graphdb-2.0.3.jar'
require 'orientdb-jdbc-2.0.3.jar'
require 'orientdb-object-2.0.3.jar'
require 'orientdb-server-2.0.3.jar'
require 'orientdb-tools-2.0.3.jar'
