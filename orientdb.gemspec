...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/jars/orientdb-client-2.0-rc1.jar",
    "lib/jars/orientdb-core-2.0-rc1.jar",
    "lib/jars/orientdb-distributed-2.0-rc1.jar",
    "lib/jars/orientdb-enterprise-2.0-rc1.jar",
    "lib/jars/orientdb-graphdb-2.0-rc1.jar",
    "lib/jars/orientdb-object-2.0-rc1.jar",
    "lib/jars/orientdb-server-2.0-rc1.jar",
